...
<html>
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/modifyBudget.css"/> "/>
...
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/customAlert.css"/> "/>
	<head>
		...
		<script type="text/javascript" src="<c:url value="/resources/js/modifyBudget.js"/>"></script>
